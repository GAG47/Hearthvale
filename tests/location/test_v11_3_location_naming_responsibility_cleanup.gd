...
func _run_tests() -> void:
	...
	_expect(location_registry.has(tavern_id), "LocationRegistry.has must find a registered Location.")
	_expect(location_registry.get(tavern_id) == tavern, "LocationRegistry.get must return the registered Location.")
