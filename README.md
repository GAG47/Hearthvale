...
世界与空间、静态 Location Graph、世界对象与交互、运行时 World State 及统一世界时间基础已经建立。当前工程可以直接运行：玩家能够通过 WorldDefinition 描述的有向连接在三个 2D 俯视格子 Location 中移动和往返，在酒馆中操作世界对象；储物箱状态与世界时间均能跨 Location Scene 生命周期持续存在，睡眠会推进到下一天 08:00。
